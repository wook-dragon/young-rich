...
<%
	...
	request.setAttribute("rw", request.getParameter("rw"));
   ...
   <div class="content" >
      <div class="comment-form-wrap pt-xl-2">
		...
		<br>
         ...
         <form name="NBW" class="p-5 bg-light" action="rewriteAct.board" method="POST">
         
         	<input type="hidden" value="${requestScope.type }" name="type">
     		<input type="hidden" value="${sessionScope.id }" name="userid">
     		
     		<input type="hidden" value="${requestScope.refer }" name="refer">
			<input type="hidden" value="${requestScope.depth }" name="depth">
			<input type="hidden" value="${requestScope.step }" name="step">
			<input type="hidden" value="${requestScope.rw }" name="rw">
